            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (location != null || location.equals("")) {
                    ...
                    if (addressList != null && addressList.size() > 0) {
                        ...
                        FindLocationActivity.this.address = address;
                    }
                }
                return false;
            }
            ...
            fusedLocationClient.getLastLocation()
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            FindLocationActivity.this.location = location;
                            markMyLocation();
                        }
                    });}
}
    ...
    private void markMyLocation() {
        if (mMap != null && location != null) {
            ...
            try {
                ...
                FindLocationActivity.this.address = address;
                Toast.makeText(FindLocationActivity.this, address.getAddressLine(0), Toast.LENGTH_SHORT).show();
            } catch (Exception e) {}
        }
    }
